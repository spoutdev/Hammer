...
public class HammerConfiguration extends ConfigurationHolderConfiguration {
	// General
	public static final ConfigurationHolder FOLDERNAME = new ConfigurationHolder("worldConvert", "general", "folder-name");
	public static final ConfigurationHolder GENERATOR = new ConfigurationHolder("normal", "general", "world-generator");
	public static final ConfigurationHolder CONVERTER = new ConfigurationHolder("minecraft", "general", "converter");
	public static final ConfigurationHolder START = new ConfigurationHolder(false, "general", "start");
